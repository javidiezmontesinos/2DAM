...
public class SimpleController {
    ...
    @FXML
    private void sumar() {
        if (operador1TextField != null && operador2TextField != null) {
            ...
            try {
                ...
                resultadoLabel.setText("Error: Ingrese números válidos en los operandos");
            }
        } else {
            resultadoLabel.setText("Error: Al menos uno de los campos de operador es nulo");
        }
    }
