...
public class tabla2 {
    ...
    public static void main(String[] args) {
        ...
        try (Connection conexion = DriverManager.getConnection(url, usuario, contraseña)) {
            ...
            String consultaNombres = "SELECT nombre FROM producto";
            Statement statement1 = conexion.createStatement();
            ResultSet resultSet1 = statement1.executeQuery(consultaNombres);
            ...
            while (resultSet3.next()) {
                ...
                String descripcionProducto = resultSet3.getString("descripcion");

                System.out.println("ID: " + idProducto + ", Nombre: " + nombreProducto +
                        ", Precio: " + precioProducto + ", Descripción: " + descripcionProducto);
            }
