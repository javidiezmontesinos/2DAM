package conectarmysqlphoneland;
...
public class ClienteModel {
    ...
    public List<Cliente> getAllClientes() throws SQLException {
        List<Cliente> clientes = new ArrayList<Cliente>(); // Inicializa una lista para almacenar los clientes
        ...
        while (rs.next()) {
            ...
            clientes.add(new Cliente(id, nif, nombre, direccion)); // Agrega cada Cliente a la lista
        }
